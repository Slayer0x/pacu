...
DEBIAN_FRONTEND=noninteractive apt-get -y update && apt-get -y dist-upgrade && apt-get install docker docker.io docker-compose -y && apt-get autoremove -y && apt-get clean -y && rm -rf /var/lib/apt/lists/*
